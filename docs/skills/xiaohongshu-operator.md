...
一个精通小红书平台调性的专家角色。AI 扮演小红书运营操盘手,擅长生活方式内容创作、趋势捕捉、审美叙事,能帮你从选题、文案到封面、发布策略全流程产出笔记内容。适合想在小红书做账号、发笔记但不懂运营的用户。

<div class="review-box">
  <h3>🔍 实测报告</h3>
  <div class="review-stars">★★★★☆ <span class="review-stars-num">4/5</span> <span class="rv-level">入门可用</span></div>
  <p class="review-summary">完整的小红书运营人设:选题、文案、封面、发布策略都覆盖,直接让 AI 扮演即可用;内容偏营销向。</p>
...
<div class="compare-box">
  ...
  <table class="compare-table">
    ...
    <tbody>
  <tr>
    <td class="cmp-scene">想在小红书发笔记</td>
    <td class="cmp-without">AI 写出来的笔记没调性,像广告,没人看。</td>
    <td class="cmp-with">AI 按小红书平台调性写,懂趋势、懂审美,像真运营。</td>
  </tr>
  <tr>
    <td class="cmp-scene">不知道发什么内容</td>
    <td class="cmp-without">想半天没选题,断更。</td>
    <td class="cmp-with">AI 帮你追趋势、找选题,内容源源不断。</td>
  </tr>
  <tr>
    <td class="cmp-scene">发了没人收藏</td>
    <td class="cmp-without">笔记沉底,不知道为什么。</td>
    <td class="cmp-with">AI 懂收藏率逻辑,优化标题、封面、正文。</td>
  </tr>
    </tbody>
  </table>
  <div class="demo-box">
    ...
    <div class="demo-chat">
      <div class="demo-step note"><span class="demo-prompt">你:帮我想想今晚发什么小红书笔记</span></div>
    <div class="demo-step ai">AI:先看近期平台趋势,结合你的账号定位给 3 个选题。</div>
    <div class="demo-step ai">AI:推荐选题+写好笔记初稿,配封面文字建议。</div>
    <div class="demo-step ai">AI:给出发布时间和标题优化建议 ✅</div>
    </div>
  </div>
</div>
...
<div class="ask-box">
  <pre class="ask-phrase">帮我安装 小红书运营专家 这个技能,它来自 https://github.com/jnMetaCode/agency-agents-zh ,装好告诉我是干什么的</pre>
  <button class="copy-btn big" data-copy="帮我安装 小红书运营专家 这个技能,它来自 https://github.com/jnMetaCode/agency-agents-zh ,装好告诉我是干什么的">复制这句话</button>
</div>
...
<div class="origin-box">
  ...
  <ul>
    ...
    <li>仓库路径:marketing/marketing-xiaohongshu-specialist.md</li>
  </ul>
</div>
