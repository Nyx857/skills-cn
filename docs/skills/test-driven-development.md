...
<div class="ask-box">
  <pre class="ask-phrase">帮我安装 test-driven-development 这个技能,它来自 https://github.com/obra/superpowers ,装好告诉我是干什么的</pre>
  <button class="copy-btn big" data-copy="帮我安装 test-driven-development 这个技能,它来自 https://github.com/obra/superpowers ,装好告诉我是干什么的">复制这句话</button>
</div>
...
<div class="origin-box">
  ...
  <ul>
    ...
    <li>仓库路径:skills/test-driven-development</li>
  </ul>
</div>
