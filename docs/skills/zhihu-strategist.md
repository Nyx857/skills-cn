...
精通知乎平台的运营专家角色。AI 扮演知乎运营顾问,懂高质量回答的结构、专业人设经营、盐值提升和选题捕捉,能帮你写出专业、有深度的知乎回答和文章。适合在知乎做内容、想提升影响力的用户。

<div class="review-box">
  <h3>🔍 实测报告</h3>
  <div class="review-stars">★★★★☆ <span class="review-stars-num">4/5</span> <span class="rv-level">入门可用</span></div>
  <p class="review-summary">知乎向运营人设:高赞回答结构、专业调性、盐值经营都有;适合知乎内容创作者。</p>
...
<div class="compare-box">
  ...
  <table class="compare-table">
    ...
    <tbody>
  <tr>
    <td class="cmp-scene">想在知乎回答涨粉</td>
    <td class="cmp-without">回答没人赞,没存在感。</td>
    <td class="cmp-with">AI 懂高赞回答结构,写得更专业、更抓人。</td>
  </tr>
  <tr>
    <td class="cmp-scene">不知道怎么选题</td>
    <td class="cmp-without">不知道回答什么问题。</td>
    <td class="cmp-with">AI 帮找高价值问题,结合你专业给建议。</td>
  </tr>
  <tr>
    <td class="cmp-scene">想经营专业人设</td>
    <td class="cmp-without">回答东一榔头西一棒子。</td>
    <td class="cmp-with">AI 帮你保持专业调性,积累信任。</td>
  </tr>
    </tbody>
  </table>
  <div class="demo-box">
    ...
    <div class="demo-chat">
      <div class="demo-step note"><span class="demo-prompt">你:帮我回答知乎问题:小白怎么学编程</span></div>
    <div class="demo-step ai">AI:先分析问题,定回答结构——先给结论,再讲方法,最后给资源。</div>
    <div class="demo-step ai">AI:写专业、有干货的回答,避免空洞。</div>
    <div class="demo-step ai">AI:给排版建议(加粗、列表),提升可读性 ✅</div>
    </div>
  </div>
</div>
...
<div class="ask-box">
  <pre class="ask-phrase">帮我安装 知乎运营专家 这个技能,它来自 https://github.com/jnMetaCode/agency-agents-zh ,装好告诉我是干什么的</pre>
  <button class="copy-btn big" data-copy="帮我安装 知乎运营专家 这个技能,它来自 https://github.com/jnMetaCode/agency-agents-zh ,装好告诉我是干什么的">复制这句话</button>
</div>
...
<div class="origin-box">
  ...
  <ul>
    ...
    <li>仓库路径:marketing/marketing-zhihu-strategist.md</li>
  </ul>
</div>
